...
import { MOCK_DYNAMICS, MOCK_SOURCES, COLORS } from '../constants';
...
export const SalesDynamicsChart: React.FC = () => {
  return (
    <div className="bg-white p-8 rounded-[24px] shadow-sm h-[420px] flex flex-col hover:shadow-md transition-shadow">
