    ...
    <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        <div className="hidden md:flex items-center bg-[#F7F5F3] p-1 rounded-[14px] border border-gray-100 shadow-inner">
          <button className="px-4 py-1.5 text-xs font-extrabold bg-white rounded-[10px] shadow-sm text-[#1A1A1A]">Monthly</button>
          <button className="px-4 py-1.5 text-xs font-bold text-gray-400 hover:text-gray-600 transition-colors">Quarterly</button>
          <button className="px-4 py-1.5 text-xs font-bold text-gray-400 hover:text-gray-600 transition-colors">Yearly</button>
        </div>

        <div className="flex items-center space-x-1">
          <button className="p-2.5 text-gray-400 hover:text-[#1A1A1A] hover:bg-[#F7F5F3] rounded-[14px] transition-all">
            <Filter className="w-5 h-5" />
          </button>

          <button className="p-2.5 text-gray-400 hover:text-[#1A1A1A] hover:bg-[#F7F5F3] rounded-[14px] transition-all relative">
