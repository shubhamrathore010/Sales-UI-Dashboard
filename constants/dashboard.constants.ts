...
import { SalesAgent, DealSource, SalesDynamic, KPIStats, TimeFrame } from '../types/dashboard.types';
...
export const MOCK_SOURCES: DealSource[] = [
  { name: 'Dribbble', value: 45000, color: COLORS.primary },
  { name: 'Instagram', value: 32000, color: '#F8B4B4' },
  { name: 'Behance', value: 28000, color: '#FFDEDE' },
  { name: 'Google Search', value: 18000, color: COLORS.charcoal },
];
...
export const TIMEFRAME_OPTIONS: TimeFrame[] = ['Monthly', 'Quarterly', 'Yearly'];
